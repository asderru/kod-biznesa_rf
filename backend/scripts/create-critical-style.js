...
async function processCss() {
    try {
        ...
        const urls = await fs.readFile('/var/www/server_1/asder_es/frontend/scripts/urls.txt', 'utf8');
        ...
        await fs.writeFile('/var/www/server_1/asder_es/frontend/web/css/critical.css', processedPurgedCss);
        console.log('Файл critical.css успешно создан');

        // Чтение содержимого critical-page.css
        const criticalAppCss = await fs.readFile('/var/www/server_1/asder_es/frontend/web/css/critical-page.css', 'utf8');
        ...
        await fs.writeFile('/var/www/server_1/asder_es/frontend/web/css/critical-page.css', finalResult);
        ...
        await fs.writeFile('/var/www/server_1/asder_es/frontend/web/css/critical-page.min.css', minifiedResult);
        ...
        await fs.writeFile('/var/www/server_1/asder_es/frontend/web/css/main.min.css', minifiedMainCss);
