...
const INPUT_FILE = '/var/www/server_1/asder_es/frontend/scripts/urls.txt';
const OUTPUT_DIR = '/var/www/server_1/asder_es/frontend/src/views/layouts';
    ...
    try {
        ...
        for (const url of urls) {
            try {
                ...
                await delay(3000);                       // Задержка 10000 мс между открытиями
