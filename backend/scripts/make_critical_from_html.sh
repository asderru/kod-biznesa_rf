...
URLS_FILE="/var/www/server_1/asder_es/frontend/scripts/urls.txt"

# Временный файл для хранения HTML
TEMP_FILE="/var/www/server_1/asder_es/frontend/tmp/temp_html_file.html"

# Целевой файл для сохранения HTML
OUTPUT_FILE="/var/www/server_1/asder_es/frontend/web/index.html"

# Путь к скрипту для создания критического стиля
CRITICAL_STYLE_SCRIPT="/var/www/server_1/asder_es/frontend/scripts/create-critical-style.js"
...
do
  ...
  if [[ -s "$TEMP_FILE" ]]; then
    ...
    # Переходим в директорию /var/www/server_1/asder_es/frontend
    cd /var/www/server_1/asder_es/frontend
