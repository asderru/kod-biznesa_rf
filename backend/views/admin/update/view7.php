<?php
    ...
    const LAYOUT_ID = '#admin_update_view7';
    
    $status     = $parent->status;
    $editorName = 'SimpleMDE';
    ...
    $parentIndexName = TypeHelper::getName($parent::TEXT_TYPE);
        ...
        <div class='col-xl-6'>
            <div class='card h-100'>
                ...
                <div class='card-body bg-light'>
                    <?php
                        try {
                            echo $form->field($model, 'description')->widget(MarkdownEditor::class, [
                                'name'          => 'description-edit',
                                'editorOptions' => [
                                    'showIcons' => ['code'],
                                    'hideIcons' => ['image'], // скрываем иконку изображения
                                ],
                            ])
                                      ->label(false)
                            ;
