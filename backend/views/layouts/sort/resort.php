<?php
    ...
    const LAYOUT_ID = '#layouts_sort_resort';
    
    $siteId = $site->id;
    
    $this->title = 'Сортировка ' . TypeHelper::getName($textType, 1, true) . '. Сайт ' . $site->name . '. #' .
                   $site->id;
...
<div class='card'>
    ...
    <div class='card-body mb-2 collapse btn-group-sm gap-2' id='collapseButtons'>
        ...
        ?>
        <?=
            ButtonHelper::structure($textType, null, 'Структура ' . TypeHelper::getName($textType, 1, true))
        ?>
        <hr>
