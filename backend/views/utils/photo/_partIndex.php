<?php
    ...
    const UTILS_PHOTO_PARTINDEX_LAYOUT = '#utils_photo_partIndex';
    echo PrintHelper::layout(UTILS_PHOTO_PARTINDEX_LAYOUT);
    ...
    <?php
        try {
            ...
            PrintHelper::exception(
                'GridView-widget ', UTILS_PHOTO_PARTINDEX_LAYOUT, $e,
            );
        }
    ?>
</div>
