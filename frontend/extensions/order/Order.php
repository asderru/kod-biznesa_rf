<?php
    ...
    namespace frontend\extensions\order;
    
    use core\edit\entities\Shop\DeliveryMethod;
    use core\edit\entities\Shop\Order\CustomerData;
    use core\edit\entities\Shop\Order\DeliveryData;
    ...
    class Order extends ActiveRecord
    {
        ...
        {
            $this->setAttribute(
                'statuses_json', Json::encode(
                array_map(function (Status $status) {
                    return [
                        'value'      => $status->value,
